...
<div class="page-content">
    <div class="container-fluid">
            ...
            <a href="{{ route('notice.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-plus-circle"> Add New Notice </i></a> <br>  <br>
            @endif
            </div>
                                    ...
                                    <tbody>
                                        @foreach($notices as $key => $item)
                                            <tr>
                                                ...
                                                <td> <a href="{{ asset('upload/notice/'. $item->notice_file) }}" class="btn btn-primary sm" title="Download" target="_blank" rel="noopener">  <i class="fas fa-file-download"></i></a> </td>
                                                {{-- <td> {{ $item->name }} </td>  --}}
                                                <td>
                                                    ...
                                                    <a href="{{ route('notice.show',$item->id) }}" class="btn btn-info sm" title="Show Data">  <i class="fas fa-eye"></i> </a>
                                                    @endif
