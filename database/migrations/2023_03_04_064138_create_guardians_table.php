...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('guardians', function (Blueprint $table) {
            ...
            $table->string('guardian_present_division_id')->nullable();
            $table->string('guardian_present_district_id')->nullable();
            $table->string('guardian_present_upazilla_id')->nullable();
            ...
            $table->string('guardian_permanent_division_id')->nullable();
            $table->string('guardian_permanent_district_id')->nullable();
            $table->string('guardian_permanent_upazilla_id')->nullable();
