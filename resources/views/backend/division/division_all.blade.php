    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('division.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                            ...
                            <tbody>
                                @foreach ($divisions as $key => $item)
                                    <tr>
                                        ...
                                        <td> {{ $item->name_bn }} </td>
                                        <td>
                                            <a href="{{ route('division.edit', $item->id) }}" class="btn btn-info sm"
                                                title="Edit Data"> <i class="fas fa-edit"></i> </a>
                                            <a href="{{ route('division.delete', $item->id) }}" class="btn btn-danger sm"
