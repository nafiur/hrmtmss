    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="px-4 py-3 rounded breadcrumb breadcrumb-alt bg-body-extra-light push fs-sm">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Spouce Information</li>
            </ol>
        </nav>

        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">Edit Spouce Information</h3>
                <a href="{{ route('all.familyspouce') }}"
            ...
            <div class="block-content">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('familyspouce.update') }}" id="myForm">
                                @csrf
                                <input type="hidden" name="id" value="{{ $familyspouce->id }}">
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input data-parsley-type="digits" data-parsley-id="15"
                                                ...
                                                class="form-control" required="" readonly value="{{ $familyspouce->employee_id }}"
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="spouce_name" class="form-control" required=""
                                                value="{{ $familyspouce->spouce_name }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="profession_id" class="form-select select2"
                                                ...
                                                <option value="{{ $profession->id }}"
                                                    {{ $profession->id == $familyspouce->profession_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_present_village"
                                                ...
                                                value="{{ $familyspouce->spouce_present_village }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_present_post" id="spouce_present_post"
                                                class="form-control" value="{{ $familyspouce->spouce_present_post }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_present_postal_code"
                                                ...
                                                value="{{ $familyspouce->spouce_present_postal_code }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_present_division_id" id="spouce_present_division_id"
                                                ...
                                                <option value="{{ $division->id }}"
                                                    {{ $division->id == $familyspouce->spouce_present_division_id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_present_district_id" id="spouce_present_district_id"
                                                ...
                                                <option value="{{ $district->id }}"
                                                    {{ $district->id == $familyspouce->spouce_present_district_id ? 'selected' : '' }}>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_present_upazilla_id" id="spouce_present_upazilla_id"
                                                ...
                                                <option value="{{ $upazilla->id }}"
                                                    {{ $upazilla->id == $familyspouce->spouce_present_upazilla_id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_permanent_village"
                                                ...
                                                value="{{ $familyspouce->spouce_permanent_village }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_permanent_post" id="spouce_permanent_post"
                                                class="form-control" value="{{ $familyspouce->spouce_permanent_post }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="spouce_permanent_postal_code"
                                                ...
                                                value="{{ $familyspouce->spouce_permanent_postal_code }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_permanent_division_id" id="permanent_division"
                                                ...
                                                @foreach ($divisions as $division)
                                                <option value="{{ $division->id }}"
                                                    {{ $division->id == $familyspouce->spouce_permanent_division_id ? 'selected' : '' }}>
                                                    {{ $division->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_permanent_district_id" id="permanent_district"
                                                ...
                                                @foreach ($districts as $district)
                                                <option value="{{ $district->id }}"
                                                    {{ $district->id == $familyspouce->spouce_permanent_district_id ? 'selected' : '' }}>
                                                    {{ $district->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select name="spouce_permanent_upazilla_id" id="permanent_upazilla"
                                                ...
                                                @foreach ($upazillas as $upazilla)
                                                <option value="{{ $upazilla->id }}"
                                                    {{ $upazilla->id == $familyspouce->spouce_permanent_upazilla_id ? 'selected' : '' }}>
                                                    {{ $upazilla->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
