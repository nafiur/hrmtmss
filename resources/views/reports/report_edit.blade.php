    ...
    <div class="container-fluid">
        ...
        <div class="block block-rounded">
            ...
            <div class="col-lg-4">
                ...
                <form class="mb-5" action="{{ route('report.update') }}" id="myform" enctype="multipart/form-data" method="POST">
                    @csrf
                    <input type="hidden" name="id" value="{{ $reports->id }}">
                    <div class="mb-4">
                    <label class="form-label" for="example-text-input">Report Title</label>
                    <input type="text" class="form-control" id="example-text-input" name="form_name" required="" value="{{ $reports->report_title }}">
                </div>
                <div class="mb-4">
                    ...
                    <input name="form_file" class="form-control" value="{{ $reports->report_file}}" type="text">
                    </div>
                    <div class="mb-4">
