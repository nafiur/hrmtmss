...
@section('admin')
@section('title'){{'Add New Notice'}} @endsection
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="block block-rounded">
            ...
            <a href="{{ route('report.all') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-undo"> Back </i></a> <br>  <br>
            </div>
            ...
            <div class="row">
                ...
                <form class="mb-5" action="{{ route('report.store') }}" id="myform" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="mb-4">
                    <label class="form-label" for="example-text-input">Notice Title</label>
                    <input type="text" class="form-control" id="example-text-input" name="notice_title" required="" value="{{old('name')}}">
                    </div>
                    <div class="mb-4">
                    ...
                    <input class="form-control" type="file" name="form_file" id="example-file-input" required="" value="{{old('form_file')}}">
                    </div>
                    <div class="mb-4">
