                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="block block-rounded text-center">
                                ...
                                <img class="img-avatar img-avatar-thumb hoverZoomLink" src="{{ asset('upload/staffprofile/Shahzadi Begum.jpg') }}" alt="">
                                </div>
                                ...
                                <button type="button" class="btn btn-light waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal"><i class="fa fa-user-circle text-muted me-1"></i> Profile</button>
                                    <!-- /.modal -->
                                    <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="myModalLabel">Details Profile</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <img id="showImage" class="rounded avatar-lg mb-4" src="{{ asset('upload/staffprofile/Shahzadi Begum.jpg') }}">
                        ...
                        <div class="content content-full content-boxed">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                              <div class="block block-rounded text-center">
                                <div class="block-content block-content-full bg-image" style="background-image: url('assets/media/photos/photo3.jpg');">
                                  <img class="img-avatar img-avatar-thumb" src="{{ asset('upload/staffprofile/10110261.jpg') }}" alt="">
                                </div>
                                <div class="block-content block-content-full block-content-sm bg-body-light">
