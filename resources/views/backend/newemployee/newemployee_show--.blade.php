                            ...
                            <form method="post" action="{{ route('newemployee.update') }}" id="myForm" >
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="employee_type_id" class="form-select" aria-label="disabled Default select example">
                                    ...
                                    <div class="col-md-5">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" value="{{ $newemployee->name }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="father_name" value="{{ $newemployee->father_name }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Mother's Name</label>
                                            <input type="text" name="mother_name" value="{{ $newemployee->mother_name }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="joiningdate" value="{{ $newemployee->joiningdate }}" readonly type="date">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Date of Birth</label>
                                            <input class="form-control" name="date_of_birth" value="{{ $newemployee->date_of_birth }}" readonly type="date">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="permanent_village" value="{{ $newemployee->permanent_village }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            <label for="example-text-input" class="form-label">Postoffice</label>
                                            <input type="text" name="permanent_post" value="{{ $newemployee->permanent_post }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            <label for="example-text-input" class="form-label">Postal Code</label>
                                            <input type="text" name="permanent_postal_code" value="{{ $newemployee->permanent_postal_code }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            <label for="example-text-input" class="form-label">Village</label>
                                            <input type="text" name="present_village" value="{{ $newemployee->present_village }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            <label for="example-text-input" class="form-label">Postoffice</label>
                                            <input type="text" name="present_post" value="{{ $newemployee->present_post }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                            <label for="example-text-input" class="form-label">Postal Code</label>
                                            <input type="text" name="present_postal_code" value="{{ $newemployee->present_postal_code }}" readonly class="form-control"  required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="mobile" value="{{ $newemployee->mobile }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Email</label>
                                            <input type="email" name="email" value="{{ $newemployee->email }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nid" value="{{ $newemployee->nid }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Smard Card</label>
                                            <input type="text" name="smartcard" value="{{ $newemployee->smartcard }}" readonly class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3 position-relative">
                                ...
                                <div class="col-md-12 fl">
                                        <input type="submit" style="float:right" class="btn btn-info waves-effect waves-light" value="Save Info">
                                </div>
                                </form>
                        </div>
                    </div>
