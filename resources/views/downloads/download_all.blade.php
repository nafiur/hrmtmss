...
<div class="page-content">
    <div class="container-fluid">
            ...
            <div class="block block-rounded">
                ...
                <h3 class="block-title">All Form & Formats</h3>
                                    ...
                                    <tbody>
                                        @foreach($downloads as $key => $item)
                                            <tr>
                                                ...
                                                <td> <a href="{{ asset('upload/downloads/form/'. $item->form_file) }}" class="btn btn-primary sm" title="Download" target="_blank" rel="noopener">  <i class="fas fa-file-download"></i></a> </td>
                                                {{-- <td> {{ $item->name }} </td>  --}}
                                                <td>
