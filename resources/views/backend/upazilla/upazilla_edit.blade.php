    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('upazilla.all') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                        ...
                        <form method="post" action="{{ route('upazilla.update') }}" id="myForm">
                                    ...
                                    <select name="division_id" class="form-select" aria-label="Default select example">
                                        ...
                                        @foreach ($division as $divi)
                                            <option value="{{ $divi->id }}"
                                                {{ $divi->id == $upazilla->division_id ? 'selected' : '' }}>
                                                {{ $divi->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="district_id" class="form-select" aria-label="Default select example">
                                        ...
                                        @foreach ($district as $district)
                                            <option value="{{ $district->id }}"
                                                {{ $district->id == $upazilla->district_id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="name" class="form-control" value="{{ $upazilla->name }}"
                                        type="text">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Upazilla Name Bangla
                                </label>
                                <div class="form-group col-sm-10">
                                    <input name="name_bn" class="form-control" value="{{ $upazilla->name_bn }}"
                                        type="text">
                                </div>
                            </div>
                            <!-- end row -->
