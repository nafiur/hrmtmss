                ...
                <div class="card">
                    <div class="card-body">
                        @if (Auth::user()->can('bloodgroup.add'))
                            <a href="{{ route('bloodgroup.add') }}"
                                class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i
                                    class="fas fa-plus-circle"> Add Blood Group </i></a> <br> <br>
                        @endif
