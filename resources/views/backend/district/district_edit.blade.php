    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('district.all') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                        ...
                        <form method="post" action="{{ route('district.update') }}" id="myForm">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="name" class="form-control" value="{{ $district->name }}"
                                        type="text">
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">District Name Bangla
                                </label>
                                <div class="form-group col-sm-10">
                                    <input name="name_bn" class="form-control" value="{{ $district->name_bn }}"
                                        type="text">
                                </div>
                            </div>
                            <!-- end row -->
