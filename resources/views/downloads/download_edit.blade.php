            ...
            <div class="block-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xl-6">
                        ...
                        <form class="mb-5" action="{{ route('download.update') }}" id="myform"
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="example-text-input" name="form_name"
                                    required="" value="{{ $downloads->form_name }}">
                            </div>
                            <div class="mb-4">
                                <label for="firstname" class="form-label">File Type </label>
                                <select name="form_type" class="form-select" id="example-select">
                                    <option selected disabled>Select Group </option>
                                    <option value="pdf"{{ $downloads->form_type == 'pdf' ? 'selected' : '' }}>PDF
                                    </option>
                                    <option value="doc"{{ $downloads->form_type == 'doc' ? 'selected' : '' }}>Word
                                    </option>
                                    <option value="xls"{{ $downloads->form_type == 'xls' ? 'selected' : '' }}>Excel
                                    </option>
                                    <option value="ppt"{{ $downloads->form_type == 'ppt' ? 'selected' : '' }}>Power
                                        Point</option>
                                    <option value="image"{{ $downloads->form_type == 'image' ? 'selected' : '' }}>Image
                                    </option>
                                </select>
                            </div>
                            <div class="mb-4">
                                ...
                                <input name="form_file" class="form-control" value="{{ $downloads->form_file }}"
                                    type="text">
                            </div>
                            <div class="mb-4">
