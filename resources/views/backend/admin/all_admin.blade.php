        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                <a href="{{ route('add.admin') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add User </i></a> <br>  <br>               
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img class="rounded-circle avatar-sm" src="{{ (!empty($item->profile_image)) ? url('upload/admin_images/'.$item->profile_image) : url('upload/no_image.jpg') }}" style="width:50px; height: 40px;"> 
                                            </td>
                                            <td>{{ $item->name }}</td>
                                            <td>{{ $item->email }}</td>
                                            <td>{{ $item->username }}</td>
