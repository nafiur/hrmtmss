    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('employeetype.add') }}"
                            class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i
                                class="fas fa-plus-circle"> Add Employee Type </i></a> <br> <br>
                            ...
                            <tbody>
                                @foreach ($employeetypes as $key => $item)
                                    <tr>
                                        ...
                                        <td> {{ $item->name }} </td>
                                        <td>
                                            <a href="{{ route('employeetype.edit', $item->id) }}" class="btn btn-info sm"
                                                title="Edit Data"> <i class="fas fa-edit"></i> </a>
                                            <a href="{{ route('employeetype.delete', $item->id) }}"
