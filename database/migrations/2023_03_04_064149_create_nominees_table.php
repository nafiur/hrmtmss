...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('nominees', function (Blueprint $table) {
            ...
            $table->string('nominee_permanent_division_id')->nullable();
            $table->string('nominee_permanent_district_id')->nullable();
            $table->string('nominee_permanent_upazilla_id')->nullable();
