            ...
            <div class="bg-image" style="background-image: url('upload/2053111.jpg')">
                <div class="row g-0 bg-primary-op">
                            ...
                            <div class="mt-4 text-center">
                                <div class="mb-3">
                                    <a href="{{ route('login') }}" class="auth-logo">
                                        <img src="{{ asset('backend/assets/images/tmss.png') }}" height="250"
                                            class="mx-auto logo-dark" alt="">
                                        {{-- <img src="{{ asset('backend/assets/images/hrm-light.png') }}" height="60" class="mx-auto logo-light" alt=""> --}}
                                    </a>
                                </div>
                            </div>
                            <!-- END Header -->
                                ...
                                <div class="col-sm-8 col-xl-6">
                                    <form class="js-validation-signin" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="py-3">
                                            <div class="mb-4">
                                                <input type="text"
                                                    class="form-control form-control-lg form-control-alt" id="username"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between">
                                                <a class="mb-1 btn btn-sm btn-alt-secondary d-block d-lg-inline-block"
                                                    href="{{ route('password.request') }}">
                                                    <i class="opacity-50 fa fa-exclamation-triangle me-1"></i> Forgot
                                                    password
                                                </a>
                                                <a class="mb-1 btn btn-sm btn-alt-secondary d-block d-lg-inline-block"
                                                    href="{{ route('register') }}">
                                                    <i class="opacity-50 fa fa-plus me-1"></i> New Account
                                                </a>
                                            </p>
                                        </div>
                                    </form>
                    ...
                    <div
                        ...
                        <div class="p-3">
                            <p class="mb-3 text-white display-5 fw-bold">
                                Welcome to
                            </p>
                            <p class="mb-3 text-white display-5 fw-bold">
                                HR-M & Admin
                            </p>
                            <p class="mb-3 text-white display-3 fw-bold">
                                TMSS
                            </p>
                            <p class="mb-0 fs-lg fw-semibold text-white-75">
