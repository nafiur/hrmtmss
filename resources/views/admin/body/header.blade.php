<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" class="px-3 btn btn-sm font-size-24 d-lg-none header-item" data-bs-toggle="collapse"
                    ...
                    <div class="p-0 dropdown-menu dropdown-menu-lg dropdown-menu-end"
                        ...
                        <div data-simplebar="init" style="max-height: 230px;">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="flex-1">
                                                            ...
                                                            <div class="font-size-12 text-muted">
                                                                ...
                                                                <p class="mb-0"><i
                                                                        class="mdi mdi-clock-outline"></i> 1 hours ago
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <div class="simplebar-track simplebar-vertical" style="visibility: hidden;">
                                <div class="simplebar-scrollbar"
                                    style="transform: translate3d(0px, 0px, 0px); display: none; height: 147px;"></div>
                            </div>
                        </div>
