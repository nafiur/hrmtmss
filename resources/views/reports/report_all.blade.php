...
@section('admin')
@section('title'){{'All Report'}} @endsection
...
<div class="page-content">
    <div class="container-fluid">
            ...
            <a href="{{ route('report.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-plus-circle"> Add New Report </i></a> <br>  <br>
            @endif
            </div>
                                    ...
                                    <tbody>
                                        @foreach($reports as $key => $item)
                                            <tr>
                                                ...
                                                <td> <a href="{{ asset('upload/report/'. $item->report_file) }}" class="btn btn-primary sm" title="Download" target="_blank" rel="noopener">  <i class="fas fa-file-download"></i></a> </td>
                                                {{-- <td> {{ $item->name }} </td>  --}}
                                                <td>
                                                    ...
                                                    <a href="{{ route('report.show',$item->id) }}" class="btn btn-info sm" title="Show Data">  <i class="fas fa-eye"></i> </a>
                                                    @endif
