                ...
                <div id="side-content" class="d-none d-md-block push">
                    ...
                    <div class="block block-rounded">
                        <div class="block-content">
                            <h4 class="mb-2 h5 text-muted">Storage</h4>
                            <p class="mb-1 h1 fw-bold">
                                920GB
                    ...
                    <!-- Storage Stats -->
                    <div class="block mb-2 block-rounded">
                        <div class="block-content border-bottom">
                            <h4 class="mb-2 h5 text-muted">Documents</h4>
                        ...
                        <div class="block-content border-bottom">
                            <h4 class="mb-2 h5 text-muted">Photos</h4>
                            <p class="mb-1 h2 fw-bold">
                                40GB
                                <span class="fs-sm text-muted">of 1TB</span>
                            </p>
                            <div class="progress push" style="height: 5px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 4%;" aria-valuenow="4"
                                    aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <div class="block-content border-bottom">
                            <h4 class="mb-2 h5 text-muted">Videos</h4>
                            <p class="mb-1 h2 fw-bold">
                                780GB
                                <span class="fs-sm text-muted">of 1TB</span>
                            </p>
                        ...
                        <div class="block-content">
                            <h4 class="mb-2 h5 text-muted">Audio</h4>
                            <p class="mb-1 h2 fw-bold">
                                20GB
                                <span class="fs-sm text-muted">of 1TB</span>
                            </p>
                            <div class="progress push" style="height: 5px;">
                                <div class="progress-bar bg-success" role="progressbar" style="width: 2%;" aria-valuenow="2"
                                    aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-8 col-lg-7 col-xl-9 order-md-0 bg-body-dark">
            <div class="content">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="px-4 py-2 rounded breadcrumb breadcrumb-alt bg-body-extra-light push fs-sm">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <div class="dropdown d-inline">
                                <a href="javascript:void(0)" id="example-dropdown-folder" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Work <i class="opacity-50 fa fa-angle-down ms-1"></i>
                                </a>
                        ...
                        <li class="breadcrumb-item active" aria-current="page">
                            <div class="dropdown d-inline">
                                <a href="javascript:void(0)" id="example-dropdown-folder-2" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Project X <i class="opacity-50 fa fa-angle-down ms-1"></i>
                                </a>
                ...
                <div class="row items-push">
                    <div class="col-sm-6 col-md-4 col-xl-3 d-flex flex-column">
                        <!-- Inspiration Folder -->
                        <div class="rounded options-container w-100 flex-grow-1 bg-body d-flex align-items-center">
                            <!-- Inspiration Folder Block -->
                            <div class="block mb-0 options-item block-rounded block-transparent w-100">
                                <div class="text-center block-content">
                                    <p class="mb-2">
                                        <i class="fa fa-folder fa-4x text-info"></i>
                                    </p>
                                    <p class="mb-0 fw-semibold fs-lg">
                                        Inspiration
                                    </p>
                                    <p class="fs-sm text-muted">
                                        14 Files
                            ...
                            <div class="rounded options-overlay bg-primary-dark-op">
                                <div class="options-overlay-content">
                                    <div class="mb-3">
                                        <a class="btn btn-primary" href="javascript:void(0)">
                                            <i class="opacity-50 fa fa-share me-1"></i> Open
                                        </a>
                                    </div>
                                    <div class="btn-group">
                        ...
                        <div class="rounded options-container w-100 flex-grow-1 bg-body d-flex align-items-center">
                            ...
                            <div class="block mb-0 options-item block-rounded block-transparent w-100">
                                <div class="text-center block-content">
                                    <p class="mb-2 overflow-hidden">
                                        <img class="img-fluid"
                                            src="{{ asset('backend/mix/assets/media/photos/photo22.jpg') }}"
                                            alt="">
                                    </p>
                            ...
                            <div class="rounded options-overlay bg-primary-dark-op">
                                <div class="options-overlay-content">
                                    <div class="mb-3">
                                        <a class="btn btn-primary" href="javascript:void(0)">
                                            <i class="opacity-50 fa fa-eye me-1"></i> View
                                        </a>
                                    </div>
                                    <div class="btn-group">
                                        <a class="btn btn-sm btn-primary" href="javascript:void(0)">
                        ...
                        <div class="rounded options-container w-100 flex-grow-1 bg-body d-flex align-items-center">
                            ...
                            <div class="block mb-0 options-item block-rounded block-transparent w-100">
                                <div class="text-center block-content">
                                    <p class="mb-2 overflow-hidden">
                                        <img class="img-fluid"
                                            src="{{ asset('backend/mix/assets/media/photos/photo21.jpg') }}"
                                            alt="">
                                    </p>
                                    <p class="mb-0 fw-semibold text-break">
                                        background_2.jpg
                        ...
                        <div class="rounded options-container w-100 flex-grow-1 bg-body d-flex align-items-center">
                            ...
                            <div class="block mb-0 options-item block-rounded block-transparent w-100">
                                <div class="text-center block-content">
                                    <p class="mb-2 overflow-hidden">
                                        <img class="img-fluid"
                                            src="{{ asset('backend/mix/assets/media/photos/photo24.jpg') }}"
                                            alt="">
                                    </p>
                                    <p class="mb-0 fw-semibold text-break">
                                        background_3.jpg
                            ...
                            <div class="row dt-row">
                                <div class="col-sm-12">
                                    <table
                                        ...
                                        <thead>
                                            <tr>
                                                <th class="text-center sorting sorting_asc" style="width: 80px;"
                                                ...
                                                <th class="d-none d-sm-table-cell sorting" style="width: 30%;"
                                                    tabindex="0" aria-controls="DataTables_Table_2" rowspan="1"
                                                    colspan="1" aria-label="Email: activate to sort column ascending">
                                                    Email</th>
                                                <th class="d-none d-sm-table-cell sorting" style="width: 15%;"
                                                    tabindex="0" aria-controls="DataTables_Table_2" rowspan="1"
                                                    colspan="1" aria-label="Access: activate to sort column ascending">
                                                    Access</th>
                                                <th style="width: 15%;" class="sorting" tabindex="0"
                                                    aria-controls="DataTables_Table_2" rowspan="1" colspan="1"
                                                    aria-label="Registered: activate to sort column ascending">Registered
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-5">
                                    <div class="dataTables_info" id="DataTables_Table_2_info" role="status"
                                        aria-live="polite">Page <strong>1</strong> of <strong>4</strong></div>
                                </div>
                                    ...
                                    <div class="dataTables_paginate paging_full_numbers" id="DataTables_Table_2_paginate">
                                        <ul class="pagination">
                                            <li class="paginate_button page-item first disabled"
                                                id="DataTables_Table_2_first"><a href="#"
                                                    aria-controls="DataTables_Table_2" data-dt-idx="first" tabindex="0"
                                                    class="page-link"><i class="fa fa-angle-double-left"></i></a></li>
                                            <li class="paginate_button page-item previous disabled"
                                                id="DataTables_Table_2_previous"><a href="#"
                                                    aria-controls="DataTables_Table_2" data-dt-idx="previous"
                                                    tabindex="0" class="page-link"><i class="fa fa-angle-left"></i></a>
                                            </li>
                                            ...
                                            <li class="paginate_button page-item next" id="DataTables_Table_2_next"><a
                                                    href="#" aria-controls="DataTables_Table_2" data-dt-idx="next"
                                                    tabindex="0" class="page-link"><i
                                                        class="fa fa-angle-right"></i></a></li>
                                            <li class="paginate_button page-item last" id="DataTables_Table_2_last"><a
                                                    href="#" aria-controls="DataTables_Table_2" data-dt-idx="last"
                                                    tabindex="0" class="page-link"><i
